  ...
  return <main>
    ...
    <Section>
      <div className="grid items-start gap-12 md:grid-cols-2">
        ...
        <Reveal delay={150}>
          {/* 건물 안내: 모바일은 4:3로 살짝 크롭해 마커를 크게, md+는 원본 비율 전체 */}
          <img
            src={photos.buildingGuide.src}
            alt={photos.buildingGuide.alt}
            loading="lazy"
            className="aspect-[4/3] w-full rounded-3xl border border-line object-cover shadow-card md:aspect-[1800/959]"
          />
          <div className="mt-4 flex flex-wrap gap-3">
