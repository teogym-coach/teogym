      ...
      <div className="grid items-center gap-12 md:grid-cols-2">
        <Reveal>
          <SectionTitle
            ...
            desc="회원마다 진행한 운동, 중량, 반복 횟수, 세트, 운동 부위가 다릅니다. 수업 내용을 기록하지 않으면 이전 수업과의 연결성이 약해지기 쉽습니다. 그날그날 컨디션과 몸 상태가 달라지는데 매번 같은 프로그램만 반복해서는 변화를 만들기 어렵습니다. 테오짐 PT 청라점에서는 수업 기록을 단순한 일지로 보관하지 않습니다. 다음 수업 전에 직전 운동과 같은 부위의 이전 기록, 회원의 운동 강도 체감과 몸 상태를 확인하고 종목, 순서와 강도를 조정하는 자료로 활용합니다."
          />
        </Reveal>
