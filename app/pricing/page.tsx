  ...
  return <main>
    ...
    <Section>
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3">
        {[
          { title: '1:1 PT', desc: '대표가 직접 수업하고 매 수업 기록을 남기는 전담 수업입니다. 구성과 비용은 상담 후 목적에 맞춰 안내드립니다.' },
          { title: '체험 · 첫 등록', desc: '체험 수업과 신규 회원 한정 첫 등록 혜택은 몸 상태와 목표 상담 후 안내드립니다.' },
      ...
      <Reveal><p className="mt-8 max-w-3xl leading-8 text-ink-soft">가격을 상담 후 안내드리는 이유는 사람마다 필요한 수업 횟수와 관리 범위가 다르기 때문입니다. 같은 목표라도 운동 경험, 체형, 생활패턴에 따라 구성이 달라집니다. 테오짐은 매 수업 기록을 근거로 관리하는 곳이므로, 상담에서 현재 몸 상태를 확인하고 필요한 만큼만 제안드립니다.</p></Reveal>
    </Section>
