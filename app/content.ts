...
export const pageMeta = {
  ...
  system: {
    title: '테오짐 PT 시스템 | 테오짐 PT 청라점',
    description: '테오짐 PT 시스템을 8단계로 소개합니다. 상담, 움직임 평가, 목표 설정, 운동 기록, PT 수업, 피드백, 다음 수업 설계, 회원 전용 앱 변화 분석까지 하나로 관리합니다.',
    path: '/system/',
  },
};
...
export const faqs = {
  ...
  system: [
    { q: '운동을 처음 시작해도 가능한가요?', a: '네, 가능합니다. 상담과 움직임 평가에서 현재 체력과 가동성을 먼저 확인한 뒤, 몸 상태에 맞는 강도로 시작합니다.' },
    { q: '운동 프로그램은 모두 같은가요?', a: '아닙니다. 목표와 움직임 평가 결과가 회원마다 다르고, 매 수업의 운동 기록에 따라 다음 수업이 계속 조정되기 때문에 프로그램도 회원마다 달라집니다.' },
    { q: '운동 기록은 왜 남기나요?', a: '지난 기록이 다음 수업의 기준이 되기 때문입니다. 무게, 횟수, 볼륨, RPE, 컨디션을 남겨 감이 아니라 기록을 근거로 다음 운동을 설계합니다.' },
    { q: '회원 앱은 어떻게 사용하나요?', a: '수업에서 쌓인 운동 기록과 체중 변화, 다음 수업 일정을 회원 전용 앱에서 언제든 확인할 수 있습니다.' },
  ],
} as const;
