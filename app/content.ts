...
export const pageMeta = {
  ...
  pricing: {
    ...
    description: '1:1 PT 회당 4만원 기준. 체험 수업, 첫 등록, 2:1 수업은 몸 상태와 목표 상담 후 안내드립니다. 가격 FAQ를 확인하세요.',
    path: '/pricing/',
  },
  cases: {
...
// ─────────────────────────────────────────────────────────────
export const photos = {
  heroStudio: { src: '/images/hero-studio.jpg', alt: '테오짐 PT 청라점 스튜디오 내부 전경', ratio: '16/11', label: '스튜디오 대표 사진 (가로)' },
...
export const faqs = {
  home: [
    ...
    { q: 'PT 가격은 어떻게 되나요?', a: '1:1 PT 회당 4만원 기준으로 안내드립니다. 체험 수업, 첫 등록, 2:1 수업은 몸 상태와 목표 상담 후 안내드립니다.' },
  ...
  pricing: [
    { q: '왜 정확한 가격을 상담 후 안내하나요?', a: '몸 상태, 목표, 필요한 수업 횟수가 사람마다 다르기 때문입니다. 1:1 PT 회당 4만원 기준으로, 상담에서 필요한 구성만 안내드립니다.' },
